...
{
    public partial class Fix_ProductId_Type : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessNature = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    BusinessCategory = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    SocialMedia = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    MpesaPaybill = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    MpesaTillNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PreferredPaymentChannel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    KRAPINCertificate = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    BusinessRegistrationCertificate = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    ReturnPolicy = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchKeyWord = table.Column<string>(type: "nvarchar(500)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleID = table.Column<int>(type: "int", nullable: false),
                    SubModuleUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaymentMethodID = table.Column<int>(type: "int", nullable: false),
                    TrxReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentDetails_PaymentMethods_PaymentMethodsPaymentMethodID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordChangesOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeliveryStationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeliveryStationName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    TownId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubCategoryUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostalAddress = table.Column<string>(type: "nvarchar(200)", nullable: false),
                    County = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Town = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    PostalCode = table.Column<string>(type: "varchar(10)", nullable: false),
                    ExtraInformation = table.Column<string>(type: "nvarchar(500)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CartName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryScheduleDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    OrderedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    PaymentID = table.Column<int>(type: "int", nullable: false),
                    PaymentConfirmation = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductsProductId = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    UsersUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductsProductId1 = table.Column<string>(type: "nvarchar(50)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItem_Products_ProductsProductId1",
                        column: x => x.ProductsProductId1,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrdersOrderID = table.Column<string>(type: "nvarchar(50)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Carrier = table.Column<string>(type: "nvarchar(100)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItem_ProductsProductId1",
                table: "CartItem",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetails_PaymentMethodsPaymentMethodID",
                table: "PaymentDetails",
